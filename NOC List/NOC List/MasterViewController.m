...
//        [self.agents addObject:anAgent];
        ...
        // Alternate way to write in one line
        [self.agents addObject:[Agent agentWithDictionary:anAgentDictionary]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AgentDetail" forIndexPath:indexPath];
